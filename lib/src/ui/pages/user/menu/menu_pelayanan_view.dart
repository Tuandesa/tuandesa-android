...
import 'package:tuandesa/src/models/pelayanan_model.dart';
import 'dart:convert';
...
class MenuPelayananView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _MenuPelayananViewState();
}

class _MenuPelayananViewState extends State<MenuPelayananView> {
  @override
  void initState() {
    super.initState();
    ...
    JenisModel.getJenis("pelayanan").then((value) {
      if (value.status) {
            ...
            child: Container(
              child: Column(
                ...
                children: <Widget>[
                  text("Jenis Layanan"),
                  FutureBuilder(
                    future: JenisModel.getJenis("pelayanan"),
                    ...
                    child: ButtonTheme(
                      ...
                      child: RaisedButton(
                          onPressed: loading
                              ? null
                              : () {
                                  if (jenisPelayananSelected == null ||
                                      komentar == null ||
                                      lampiran.length == 0) {
                                    ShowAlert.show(context, "Validasi",
                                        "Semua data harus diisi!");
                                  } else {
                                    postPelayanan(context);
                                  }
                                },
  ...
  void postPelayanan(context) async {
