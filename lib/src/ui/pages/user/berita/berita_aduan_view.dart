                  ...
                  footer: CustomFooter(
                    builder: (BuildContext context, LoadStatus mode) {
                      ...
                      if (mode == LoadStatus.idle) {
                        body = Text("Tarik atas untuk lebih");
                        ...
                        body = Text("Lepas untuk mengambil data");
                      } else {
...
class ListItem extends StatelessWidget {
  const ListItem(
      {Key key, @required this.aduanModel, this.userId, this.aduanBloc})
      : super(key: key);
  ...
  void deleteAduan({String id, context}) async {
